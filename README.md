...
### Камера
  Для определения цвета знаков было решено использовать модуль технического зрения OpenMV H7 plus. Он является сенсорным устройством для исследования окружающего пространства путем обработки и анализа изображения со встроенной видеокамеры. Данная камера проста в программировании и всего за пару минут можно полностью написать код поиска кубиков, как это сделали мы.

### Драйвер двигателя
   В качестве драйвера двигателя используется модуль на основе микросхемы drv8833. Данный модуль неприхотлив, прост в использовании и идеально подходит к нашему двигателю.
