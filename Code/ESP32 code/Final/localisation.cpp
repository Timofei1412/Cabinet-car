...
void refresh_points(){
    ...
    if (lidar.points_amount > 30){
        ...
        if(move){
            ...
            debug.print(" ");
            debug.print(distance_to_side_line);
            debug.print(" ");
            debug.print(distance_to_back_line);
            debug.print(" ");
            debug.println(robot_angle_local);
...
void check_blobs(){
    ...
    /*for(int i=0; i<10; i++){
        debug.print(blob_pot_coords_corrected[i].x);
        debug.print(" ");
        debug.print(blob_pot_coords_corrected[i].y);
        debug.print(" : ");
    }
    debug.println();*/
...
void colorize_blobs(){
    ...
    for(int i=0; i<uncolored_blobs_count; i++){
        ...
        if(side_check && (camera_blob_color == -1 || camera_blob_color == 1)){
...
void separate_lines(){
    ...
    if(segments.segments_count != 0){
        ...
        /*for(int i=0; i<4; i++){
            debug.print(min_indexes[i]);
            debug.print(" ");
            debug.print(min_angles[i]);
            debug.print(" : ");
        }
        debug.println();*/
